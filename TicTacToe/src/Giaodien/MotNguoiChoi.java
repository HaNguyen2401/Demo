...
import GiaiThuat.MiniMax2;
import GiaiThuat.Minimax;
import game.Board;
import game.Mark;
...
public class MotNguoiChoi extends JFrame {
	...
	public MotNguoiChoi() {
			...
			public void actionPerformed(ActionEvent e) {
				if (level) {
					...
					if (!board.isTileMarked(0, 0)) {
						...
						checkWin(0, 0);
						if (!check) {
							int bestMove[] = MiniMax2.getBestMove(board);
							System.out.println(bestMove[0] + " " + bestMove[1]);
							if (bestMove[0] == 0 && bestMove[1] == 1) {
								btnCheck2.setText("O");
							} else if (bestMove[0] == 0 && bestMove[1] == 2) {
		...
		JButton btnPlayAgain = new JButton("Chơi Lại");
		...
		btnPlayAgain.setBackground(new Color(221,160,221));
		...
		btnFinish.setBackground(new Color(221,160,221));

		JButton btnBackToMenu = new JButton("Trang Chủ");
		...
		btnBackToMenu.setBackground(new Color(221,160,221));

		JPanel panel = new JPanel();
		panel.setInheritsPopupMenu(true);
		panel.setBackground(new Color(221,160,221));
		panel.setBounds(500, 128, 222, 354);
		contentPane.add(panel);
		panel.setLayout(null);

		JLabel lblNewLabel_1 = new JLabel("MÁY");
